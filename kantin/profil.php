...
<div class="row mt-3">
    ...
    <div class="row mt-3">
        <div class="row col-md-6 text-center ms-3 py-4 box" style="background: #C4DDFF; border-radius: 25px;">
    ...
    <div class="row">
      ...
      <button class="security ms-2">Pengaturan Keamanan</button> <img src="img/arrow.png" style="margin-left: -35px;">
    </div>
    <a href="logout.php" class="btn mt-2">logout</a> 
    </div>
