$.getJSON('https://archnist.github.io/strvz.github.io/tugasSKJ/js/juz4.json', function(surah1) {
    let surah2 = surah1;
    $.each(surah2, function(i, surah1) {
        $('#ayat').append('<div class="bacaan"><h3>'+ surah1.surah +'</h3><h2>'+ surah1.ar +'</h2><h5>'+ surah1.nomor +'. '+ surah1.tr +'</h5><h4>'+ surah1.nomor +'. '+ surah1.id +'</h4></div>')
    });
});
