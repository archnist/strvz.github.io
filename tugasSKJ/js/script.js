$.getJSON('https://al-quran-8d642.firebaseio.com/data.json?print=pretty', function(data) {
    ...
    $.each(surah, function(i, data) {
        $('#daftar-surah').append('<a class="link" href="surah2.html"><div class="card"><h4>'+ data.nama +' ('+ data.nomor +')</h4> <h5>'+ data.arti +' ('+ data.ayat +' ayat)</h5><div class="lafaz"><h4>'+ data.asma +'</h4></div></div></a>')
    });
});
