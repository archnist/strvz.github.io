$.getJSON('https://archnist.github.io/strvz.github.io/tugasSKJ/js/data.json', function(data) {
    let surah = data; 
    $.each(surah, function(i, data) {
        $('#daftar-surah').append('<span><a class="link'+ data.nomor +'" href="'+ data.link +'"><div class="card"><h4>'+ data.nama +' ('+ data.nomor +')</h4> <h5>'+ data.arti +' ('+ data.ayat +' ayat)</h5><div class="lafaz"><h4>'+ data.asma +'</h4></div></div></a></span>')
    }); 
});

$.getJSON('https://archnist.github.io/strvz.github.io/tugasSKJ/js/juz.json', function(data) {
    let juz = data;
...
menu1.addEventListener("click", function() {
    ...
    search.classList.remove("selesai2");
    setTimeout(() => {
